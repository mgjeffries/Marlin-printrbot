...
#define STRING_CONFIG_H_AUTHOR "(mgjeffries)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 37.12
    #define DEFAULT_Ki 2.98
    #define DEFAULT_Kd 115.55
  #endif
#endif // PIDTEMP
...
// #define X_BED_SIZE 252   // Printrbot XL print bed
